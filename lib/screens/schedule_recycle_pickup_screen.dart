...
class ScheduleRecyclePickupScreen extends StatefulWidget {
  ...
  const ScheduleRecyclePickupScreen({
    Key? key,
  ...
  @override
  State<ScheduleRecyclePickupScreen> createState() =>
      _ScheduleRecyclePickupScreenState();
}

class _ScheduleRecyclePickupScreenState
    extends State<ScheduleRecyclePickupScreen> {
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) => SuccessScreen(
              ...
              details:
                  'Your recycling pickup is scheduled for ${DateFormat('MMMM d, yyyy').format(scheduledDateTime)} at ${_selectedTime!.format(context)}',
            ),
          ),
        );
      }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Weight: ${widget.itemWeight} kg'),
            const SizedBox(height: 16),
            Text(
              'Pickup Details',
              style: Theme.of(context).textTheme.titleLarge,
